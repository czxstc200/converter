...
public class ConvertVideoPacket {
    ...
    public static void main(String[] args) throws Exception, IOException {
        ConvertVideoPacket convertVideoPacket = new ConvertVideoPacket().from("rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov")
                .to("/Users/czx/Downloads/1.flv"); //rtmp://10.112.217.199/live360p/test3
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    convertVideoPacket.go();
                }catch (IOException e){
