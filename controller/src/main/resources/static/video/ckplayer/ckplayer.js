...
function ckplayerConfig() {
	return {
		...
		style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内容
			...
			logo: {
				file: 'data:image/png;base64,',
				align: 'right',
				vAlign: 'top',
				offsetX: -100,
				offsetY: 10
...
!(function() {
	...
	ckplayer.prototype = {
		...
		*/
		...
		/*
			内部监听函数，调用方式：
			this.addListenerInside('click',function(cn.edu.bupt.event){},[ID]);
			d值为空时，则表示监听当前的视频播放器
		*/
		...
		/*
			删除内部监听函数，调用方式：
			this.removeListenerInside('click',function(cn.edu.bupt.event){}[,ID]);
			d值为空时，则表示监听当前的视频播放器
		*/
