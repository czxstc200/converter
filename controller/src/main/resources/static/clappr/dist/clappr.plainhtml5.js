...
var eventsApi = function eventsApi(obj, action, name, rest) {
  ...
  // Handle space separated cn.edu.bupt.event names.
...
var triggerEvents = function triggerEvents(events, args, klass, name) {
  ...
  function run() {
    try {
      ...
      _log2.default.error.apply(_log2.default, [klass, 'error on cn.edu.bupt.event', name, 'trigger', '-', exception]);
      run();
    }
  }
};
...
var Events = function () {
  ...
  /**
   * listen to an cn.edu.bupt.event indefinitely, if you want to stop you need to call `off`
   * @method on
   * @param {String} name
  ...
  /**
   * listen to an cn.edu.bupt.event only once
   * @method once
   * @param {String} name
   * @param {Function} callback
   * @param {Object} context
  ...
  /**
   * stop listening to an cn.edu.bupt.event
   * @method off
   * @param {String} name
   * @param {Function} callback
   * @param {Object} context
  ...
  /**
   * triggers an cn.edu.bupt.event given its `name`
   * @method trigger
   * @param {String} name
   */
  ...
  /**
   * stop listening an cn.edu.bupt.event for a given object
  ...
  Events.register = function register(eventName) {
    ...
    } else _log2.default.error('Events', 'Error when register cn.edu.bupt.event: ' + eventName);
  };
...
/**
 * listen to an cn.edu.bupt.event indefinitely for a given `obj`
 * @method listenTo
 * @param {Object} obj
 * @param {String} name
 * @param {Function} callback
 ...
 */
/**
 * listen to an cn.edu.bupt.event once for a given `obj`
 * @method listenToOnce
 * @param {Object} obj
 * @param {String} name
 * @param {Function} callback
 ...
 *
 * @cn.edu.bupt.event PLAYER_READY
 */
Events.PLAYER_READY = 'ready';
/**
 * Fired when player resizes
 *
 * @cn.edu.bupt.event PLAYER_RESIZE
 ...
 *
 * @cn.edu.bupt.event PLAYER_FULLSCREEN
 ...
 *
 * @cn.edu.bupt.event PLAYER_PLAY
 */
Events.PLAYER_PLAY = 'play';
/**
 * Fired when player pauses
 *
 * @cn.edu.bupt.event PLAYER_PAUSE
 */
Events.PLAYER_PAUSE = 'pause';
/**
 * Fired when player stops
 *
 * @cn.edu.bupt.event PLAYER_STOP
 */
Events.PLAYER_STOP = 'stop';
/**
 * Fired when player ends the video
 *
 * @cn.edu.bupt.event PLAYER_ENDED
 */
Events.PLAYER_ENDED = 'ended';
/**
 * Fired when player seeks the video
 *
 * @cn.edu.bupt.event PLAYER_SEEK
 ...
 *
 * @cn.edu.bupt.event PLAYER_ERROR
 ...
 *
 * @cn.edu.bupt.event PLAYER_TIMEUPDATE
 ...
 *
 * @cn.edu.bupt.event PLAYER_VOLUMEUPDATE
 ...
 *
 * @cn.edu.bupt.event PLAYER_SUBTITLE_AVAILABLE
 */
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_PROGRESS
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_TIMEUPDATE
 * @param {Object} progress Data
 * progress object
 * @param {Number} [progress.current]
 * current time (in seconds)
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_READY
 */
 ...
 * `true`.
 *
 * @cn.edu.bupt.event PLAYBACK_BUFFERING
 */
 ...
 * `false`.
 *
 * @cn.edu.bupt.event PLAYBACK_BUFFERFULL
 */
Events.PLAYBACK_BUFFERFULL = 'playback:bufferfull';
/**
 * Fired when playback changes any settings (volume, seek and etc)
 *
 * @cn.edu.bupt.event PLAYBACK_SETTINGSUPDATE
 */
Events.PLAYBACK_SETTINGSUPDATE = 'playback:settingsupdate';
/**
 * Fired when playback loaded its metadata
 *
 * @cn.edu.bupt.event PLAYBACK_LOADEDMETADATA
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_HIGHDEFINITIONUPDATE
 * @param {Boolean} isHD
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_BITRATE
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_LEVELS_AVAILABLE
 * @param {Array} levels
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_LEVEL_SWITCH_START
 *
 */
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_LEVEL_SWITCH_END
 *
 */
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_PLAYBACKSTATE
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_DVR
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_ENDED
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_PLAY_INTENT
 */
 ...
 * I.e. `isPlaying()` might return `true` before this cn.edu.bupt.event is fired,
 * because `isPlaying()` represents the intended state.
 *
 * @cn.edu.bupt.event PLAYBACK_PLAY
 */
Events.PLAYBACK_PLAY = 'playback:play';
/**
 * Fired when the media for a playback pauses.
 *
 * @cn.edu.bupt.event PLAYBACK_PAUSE
 */
Events.PLAYBACK_PAUSE = 'playback:pause';
/**
 * Fired when the media for a playback is seeking.
 *
 * @cn.edu.bupt.event PLAYBACK_SEEK
 */
Events.PLAYBACK_SEEK = 'playback:seek';
/**
 * Fired when the media for a playback is seeked.
 *
 * @cn.edu.bupt.event PLAYBACK_SEEKED
 */
Events.PLAYBACK_SEEKED = 'playback:seeked';
/**
 * Fired when the media for a playback is stopped.
 *
 * @cn.edu.bupt.event PLAYBACK_STOP
 */
Events.PLAYBACK_STOP = 'playback:stop';
/**
 * Fired if an error occurs in the playback.
 *
 * @cn.edu.bupt.event PLAYBACK_ERROR
 ...
 *
 * @cn.edu.bupt.event PLAYBACK_SUBTITLE_AVAILABLE
 */
Events.PLAYBACK_SUBTITLE_AVAILABLE = 'playback:subtitle:available';
/**
 * Fired when playback subtitle track has changed
 *
 * @cn.edu.bupt.event CONTAINER_SUBTITLE_CHANGED
 ...
 *
 * @cn.edu.bupt.event CORE_CONTAINERS_CREATED
 */
Events.CORE_CONTAINERS_CREATED = 'core:containers:created';
/**
 * Fired when the options were changed for the core
 *
 * @cn.edu.bupt.event CORE_OPTIONS_CHANGE
 */
Events.CORE_OPTIONS_CHANGE = 'core:options:change';
/**
 * Fired after creating containers, when the core is ready
 *
 * @cn.edu.bupt.event CORE_READY
 */
Events.CORE_READY = 'core:ready';
/**
 * Fired when the fullscreen state change
 *
 * @cn.edu.bupt.event CORE_FULLSCREEN
 * @param {Boolean} whether or not the player is on fullscreen mode
 */
 ...
 *
 * @cn.edu.bupt.event CORE_RESIZE
 * @param {Object} currentSize an object with the current size
 */
Events.CORE_RESIZE = 'core:resize';
/**
 * Fired when the screen orientation has changed.
 * This cn.edu.bupt.event is trigger only for mobile devices.
 *
 * @cn.edu.bupt.event CORE_SCREEN_ORIENTATION_CHANGED
 * @param {Object} screen An object with screen orientation
 * screen object
 * @param {Object} [screen.cn.edu.bupt.event]
 * window resize cn.edu.bupt.event object
 ...
 *
 * @cn.edu.bupt.event CONTAINER_PLAYBACKSTATE
 * @param {Object} state Data
 * state object
 * @param {String} [state.type]
 * the playback type
 ...
 *
 * @cn.edu.bupt.event CONTAINER_BITRATE
 * @param {Object} bitrate Data
 * bitrate object
 * @param {Number} [bitrate.bandwidth]
 * bitrate bandwidth when it's available
 ...
 *
 * @cn.edu.bupt.event CONTAINER_READY
 */
 ...
 *
 * @cn.edu.bupt.event CONTAINER_LOADEDMETADATA
 * @param {Object} metadata Data
 * settings object
 * @param {Number} [metadata.duration]
 * the playback duration
 ...
 *
 * @cn.edu.bupt.event CONTAINER_SUBTITLE_AVAILABLE
 */
 ...
 *
 * @cn.edu.bupt.event CONTAINER_TIMEUPDATE
 * @param {Object} progress Data
 * progress object
 * @param {Number} [progress.current]
 * current time (in seconds)
 ...
 *
 * @cn.edu.bupt.event CONTAINER_PROGRESS
 * @param {Object} progress Data
 * progress object
 ...
 *
 * @cn.edu.bupt.event CONTAINER_SEEK
 * @param {Number} time the current time in seconds
 */
 ...
 *
 * @cn.edu.bupt.event CONTAINER_SEEKED
 * @param {Number} time the current time in seconds
 */
 ...
 *
 * @cn.edu.bupt.event CONTAINER_STATE_BUFFERING
 */
Events.CONTAINER_STATE_BUFFERING = 'container:state:buffering';
/**
 * Fired when the container filled the buffer
 *
 * @cn.edu.bupt.event CONTAINER_STATE_BUFFERFULL
 */
Events.CONTAINER_STATE_BUFFERFULL = 'container:state:bufferfull';
/**
 * Fired when the container changes any settings (volume, seek and etc)
 *
 * @cn.edu.bupt.event CONTAINER_SETTINGSUPDATE
 */
Events.CONTAINER_SETTINGSUPDATE = 'container:settingsupdate';
/**
 * Fired when container updates its video quality
 *
 * @cn.edu.bupt.event CONTAINER_HIGHDEFINITIONUPDATE
 * @param {Boolean} isHD
 * true when is on HD, false otherwise
 */
 ...
 *
 * @cn.edu.bupt.event CONTAINER_MEDIACONTROL_SHOW
 */
Events.CONTAINER_MEDIACONTROL_SHOW = 'container:mediacontrol:show';
/**
 * Fired when the media control hides
 *
 * @cn.edu.bupt.event CONTAINER_MEDIACONTROL_HIDE
 */
 ...
 *
 * @cn.edu.bupt.event CONTAINER_OPTIONS_CHANGE
 */
 ...
 *
 * @cn.edu.bupt.event MEDIACONTROL_FULLSCREEN
 */
Events.MEDIACONTROL_FULLSCREEN = 'mediacontrol:fullscreen';
/**
 * Fired when the media control shows
 *
 * @cn.edu.bupt.event MEDIACONTROL_SHOW
 */
Events.MEDIACONTROL_SHOW = 'mediacontrol:show';
/**
 * Fired when the media control hides
 *
 * @cn.edu.bupt.event MEDIACONTROL_HIDE
 */
Events.MEDIACONTROL_HIDE = 'mediacontrol:hide';
/**
 * Fired when mouse enters on the seekbar
 *
 * @cn.edu.bupt.event MEDIACONTROL_MOUSEMOVE_SEEKBAR
 * @param {Object} cn.edu.bupt.event
 * the javascript cn.edu.bupt.event
 */
Events.MEDIACONTROL_MOUSEMOVE_SEEKBAR = 'mediacontrol:mousemove:seekbar';
/**
 * Fired when mouse leaves the seekbar
 *
 * @cn.edu.bupt.event MEDIACONTROL_MOUSELEAVE_SEEKBAR
 * @param {Object} cn.edu.bupt.event
 * the javascript cn.edu.bupt.event
 */
 ...
 *
 * @cn.edu.bupt.event MEDIACONTROL_PLAYING
 */
Events.MEDIACONTROL_PLAYING = 'mediacontrol:playing';
/**
 * Fired when the media is not being played
 *
 * @cn.edu.bupt.event MEDIACONTROL_NOTPLAYING
 */
Events.MEDIACONTROL_NOTPLAYING = 'mediacontrol:notplaying';
/**
 * Fired when the container was changed
 *
 * @cn.edu.bupt.event MEDIACONTROL_CONTAINERCHANGED
 */
Events.MEDIACONTROL_CONTAINERCHANGED = 'mediacontrol:containerchanged';
/**
 * Fired when the options were changed for the mediacontrol
 *
 * @cn.edu.bupt.event MEDIACONTROL_OPTIONS_CHANGE
 */
...
/* Zepto v1.2.0 - zepto ajax callbacks deferred cn.edu.bupt.event ie selector - zeptojs.com/license */
...
;(function($){
  ...
  // trigger a custom cn.edu.bupt.event and return false if it was cancelled
  ...
  // trigger an Ajax "global" cn.edu.bupt.event
  ...
  // triggers an extra global cn.edu.bupt.event "ajaxBeforeSend" that's like "ajaxSend" but cancelable
...
;(function($){
  ...
  function Deferred(func) {
    var tuples = [
          // action, add cn.edu.bupt.listener, cn.edu.bupt.listener list, final state
...
;(function($){
  ...
  // triggers cn.edu.bupt.event handlers on current element just as if an cn.edu.bupt.event occurred,
  // doesn't trigger an actual cn.edu.bupt.event, doesn't bubble
  ...
  // shortcut methods for `.bind(cn.edu.bupt.event, fn)` for each cn.edu.bupt.event type
...
var Player = function (_BaseObject) {
  ...
  (0, _createClass3.default)(Player, [{
     ...
     * @property isReady
     * @type {Boolean} `true` if the player is ready. ie PLAYER_READY cn.edu.bupt.event has fired
     */
  ...
  /**
   * Gives user consent to playback. Required by mobile device after a click cn.edu.bupt.event before Player.load().
   * @method consent
   * @return {Player} itself
   */
...
// module
exports.push([module.i, "@font-face {\n  font-family: \"Roboto\";\n  font-style: normal;\n  font-weight: 400;\n  src: local(\"Roboto\"), local(\"Roboto-Regular\"), url(" + escape(__webpack_require__(170)) + ") format(\"truetype\");\n}\n", ""]);
...
var HTML5Video = function (_Playback) {
  ...
  // ideally the "loadstart" cn.edu.bupt.event would be used instead, but this fires
