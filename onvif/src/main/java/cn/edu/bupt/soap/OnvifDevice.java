package cn.edu.bupt.soap;

import cn.edu.bupt.soap.devices.ImagingDevices;
import cn.edu.bupt.soap.devices.InitialDevices;
import cn.edu.bupt.soap.devices.MediaDevices;
import cn.edu.bupt.soap.devices.PtzDevices;
...
public class OnvifDevice {
	...
	public OnvifDevice(String hostIp, String user, String password) throws ConnectException, SOAPException {
		this(hostIp,user,password,true);
	}

	public OnvifDevice(String hostIp, String user, String password,boolean isLogging) throws ConnectException, SOAPException {
		...
		this.soap.setLogging(isLogging);
